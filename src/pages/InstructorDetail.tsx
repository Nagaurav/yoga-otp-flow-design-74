    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <MobileFrame>
        <div className="flex flex-col h-full overflow-y-auto">
          {/* Header with image */}
          <div className="relative h-64 -mx-6 -mt-12">
            ...
            <Button 
              variant="ghost" 
              size="icon" 
              className="absolute top-16 left-4 text-white bg-black/30 hover:bg-black/40 rounded-full"
          ...
          <div className="bg-white rounded-t-3xl -mt-6 relative z-10 p-6 flex-1">
            ...
            <div className="flex flex-col gap-3 mb-6">
              ...
              <Button 
                variant="outline" 
                className="w-full h-12 text-base font-semibold rounded-xl border-2 border-indigo-200 text-indigo-600 hover:bg-indigo-50"
              ...
              <Button 
                variant="outline" 
                className="w-full h-12 text-base font-semibold rounded-xl border-2 border-green-200 text-green-600 hover:bg-green-50"
